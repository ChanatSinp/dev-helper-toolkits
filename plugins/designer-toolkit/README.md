...
```
mkdir -p <your-project>/.agents/plugins/designer-toolkit
cp -r plugins/designer-toolkit/skills <your-project>/.agents/plugins/designer-toolkit/skills
cp plugins/designer-toolkit/.antigravity-plugin/plugin.json <your-project>/.agents/plugins/designer-toolkit/plugin.json
```
